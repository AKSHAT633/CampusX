...
const JoinCTA = () => {
  ...
  return (
    ...
    >
      {/* GLOW BLOBS */}
      <div
        className={`absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] blur-[160px] rounded-full ${
          isDark ? "bg-blue-600/20" : "bg-blue-400/20"
        }`}
      />
      <div
        className={`absolute bottom-0 right-0 w-[400px] h-[400px] blur-[160px] rounded-full ${
      ...
      >
        ...
        >
          <div
            className={`rounded-3xl backdrop-blur-xl px-10 py-16 border ${
              isDark
          ...
          >
            ...
            <Link to="/register">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className={`relative px-8 py-4 rounded-xl font-semibold text-lg text-white bg-gradient-to-r from-blue-500 to-indigo-600 overflow-hidden ${
                  isDark
